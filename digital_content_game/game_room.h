...
{
public:
	static session_ptr create(asio::io_service&, asio::io_service::strand&, game_room&);
...
private:
	...
	game_session(asio::io_service&, asio::io_service::strand& , game_room&);
